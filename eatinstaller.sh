...
dialog --title "Installing OS Dependencies" --prgbox "Eat is installing it's dependencies. This will take a while, and the progress can be seen below." "sudo apt-get update && sudo apt-get install git python3 python3-pip -y" 1000 1000
